...
class CharDisplaySecondary extends Component {
    ...
    render() {
        ...
        const name = this.props.characters[this.props.i] ? this.props.characters[this.props.i].heroes : null
                    ...
                    <div className='img-one-background'>
                        ...
                        <div className='char-info'>
                            ...
                            <div className='buttons'>
                                <button onClick={() => this.handlePrev()} className='nav-buttons'> {`< Prev`} </button>
